package com.exemplo.controleprodutosms.view.controller;
...
import com.exemplo.controleprodutosms.service.ProdutoService;
import com.exemplo.controleprodutosms.view.model.ProdutoModeloAlteracao;
import com.exemplo.controleprodutosms.view.model.ProdutoModeloInclusao;
import com.exemplo.controleprodutosms.view.model.ProdutoModeloResponse;
...
public class ProdutoController {
    ...
    @GetMapping(value="/{data}/listar")
    public ResponseEntity<List<ProdutoModeloResponse>> obterPorData(@PathVariable Date data) {
        List<ProdutoDto> dtos = service.obterPorData(data);
